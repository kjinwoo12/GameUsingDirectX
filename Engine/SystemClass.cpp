...
bool SystemClass::Initialize() {
	...
	// If the resolution of client monitor is small then DEFAULT_SCREEN for initialize window,
	// set widht and height to maximum of client.
	screenWidth = (unsigned long)GetSystemMetrics(SM_CXSCREEN);
	screenHeight = (unsigned long)GetSystemMetrics(SM_CYSCREEN);
	if (DEFAULT_WIDTH < screenWidth) {
		screenWidth = DEFAULT_WIDTH;
	}
	if (DEFAULT_HEIGHT < screenHeight) {
